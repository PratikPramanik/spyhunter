...
public class ImagesPlayer
{
  ...
  private SpyHunterPanel watcher = null;
  
  //explosion stuff
  private boolean exploding;	//are you exploding?
  public int xPloX, xPloY;		//x and y pos of explosion
  ...
  public void setWatcher(SpyHunterPanel w)
  {  watcher = w;  }
  ...
  public boolean xplod()
  //if this imageplayer is  playing an explosion
  {
  	return exploding;
  }
  
  public void setXplod(boolean t)
  {
  	exploding = t;
  }
  
  public void xplosLoc(int x, int y)
  {
  	xPloX = x;
  	xPloY = y;
  }
